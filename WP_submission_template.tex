...
% Please submit your white paper via email to lsst-survey-strategy@lists.lsst.org or via a pull request on this repository (https://github.com/lsst-pst/survey_strategy_wp). 
